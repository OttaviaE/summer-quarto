...
- [00-Hello](slides/00-Hello/00-Hello.qmd) Let's get all set [download source](slides/00-Hello/00-Hello.qmd)

- [01-Baby steps](slides/01-Baby-steps/01-Baby-steps.qmd) Formatting with markdwon, integration with github pages & layout [download source](slides/01-Baby-steps/01-Baby-steps.qmd)

- [02-Code chunks](slides/02-Code-chunk/02-Code-chunk.qmd) How to control the executable code [download source](slides/02-Code-chunk/02-Code-chunk.qmd)
...
- [04-PDF](slides/04-PDF/04-PDF.qmd) with LaTeX [download source](slides/04-PDF/04-PDF.qmd)
